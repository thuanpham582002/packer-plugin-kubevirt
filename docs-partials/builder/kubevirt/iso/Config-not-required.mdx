...
- `ssh_local_port` (string) - SSH Local Port

- `ssh_remote_port` (string) - SSH Remote Port
...
- `winrm_local_port` (string) - Win RM Local Port

- `winrm_remote_port` (string) - Win RM Remote Port
